...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    class MouseClass {
      ...
      container: HTMLElement | null = null;
      eventTarget: (Window | HTMLElement) | null = null;
      isHoverInside = false;
      ...
      init(container: HTMLElement, useWindow: boolean) {
        this.container = container;
        this.eventTarget = useWindow ? window : container;
        const target = this.eventTarget as any;
